% This algorithm is a common Extended Kalman Filter using matrix exponential 
% 	instead of approximation for gyroscope integration.
%
...
classdef QEkfExp < ExtendedKalmanFilter
